...
build = Path('/private/tmp/nla-tr27-border-witness-final-build')
...
with (evidence / 'development-typecheck.log').open('w') as log:
    ...
    for file in ['NLA/TR27/Definitions.lean', 'NLA/TR27/Algebra.lean',
                 ...
                 'NLA/TR27/Geometry.lean',
                 'NLA/TR27/BorderWitness.lean',
                 'reviews/border-witness-author-evidence/Axioms.lean']:
