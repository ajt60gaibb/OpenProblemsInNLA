...
build = Path('/private/tmp/nla-tr27-rank-build')
...
with (evidence / 'development-typecheck.log').open('w') as log:
    ...
    for file in ['NLA/TR27/Definitions.lean', 'NLA/TR27/Algebra.lean',
                 'NLA/TR27/IntegralImage.lean', 'NLA/TR27/Independence.lean',
                 'NLA/TR27/Geometry.lean', 'NLA/TR27/RankWitness.lean',
                 'reviews/rank-author-evidence/Axioms.lean']:
