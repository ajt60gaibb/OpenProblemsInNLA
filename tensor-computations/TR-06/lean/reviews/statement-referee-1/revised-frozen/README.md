...
proof. The ten `sorry` placeholders are in the trusted Challenge only; no
...
[Linux verifier](../../../tools/lean/HARNESS.md) remain unchanged. Proof implementation follows two independent approvals of the actual
definitions, complete original-target correspondence and signatures.
