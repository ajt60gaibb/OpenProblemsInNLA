...
\vspace{6pt}
\textbf{Status:} open conjecture; explicit journal source published in
2023.
...
Searches included
\textit{"tensor" "angular condition number" "2026"} and
\textit{"angular condition" "tensor" finite proved}. No higher-rank
resolution was located. Generic uniqueness alone is not an integrability
estimate. The latest explicit conjecture located is the 2023 journal
version.
\end{document}
