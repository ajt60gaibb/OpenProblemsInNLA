...
The current v2, submitted 2026-06-18, retains Conjecture 3.18. Table 4
gives small-dimensional numerical evidence, not a general proof. On
2026-09-08, exact-title, author, discriminant and conjecture-number
searches found no resolution. Known generic critical-point counts are
different invariants. This is a bounded check.
\end{document}
