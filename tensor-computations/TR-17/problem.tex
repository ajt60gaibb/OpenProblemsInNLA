...
The October 13, 2025 revision of reference 1 explicitly retains
Conjecture 3.9. It proves local minimality for all these varieties and
global minimality for matrices, binary symmetric tensors, and ternary
symmetric cubics. Searches
\textit{"Frobenius" "ED degree" "conjecture" "2026"} and the exact
paper title with \textit{proof} located no general resolution. This
bounded check distinguishes global minimality from the proved local
theorem.
\end{document}
