...
and submission record}. That original verification was independent agent
review, without external human peer review or formal certification; the
separate Lean verification is recorded below.
...
Physics, University of Cambridge retains mathematical construction
authorship.

The real nine-point squared distance matrix has nonnegative rank seven,
including arbitrary real factors and zero or degenerate factor columns.

All 15 frozen contracts passed actual local serial Lean, two wholly
nonauthor final AI-agent source reviews, and the
\href{https://github.com/sgstepaniants/OpenProblemsInNLA/actions/runs/35431159955}{sgstepaniants
run 35431159955} and
\href{https://github.com/ajt60gaibb/OpenProblemsInNLA/actions/runs/35431201248}{ajt60gaibb
run 35431201248}. The real Comparator, default kernel, standard-axiom
checks, sandbox and rejection controls passed on the immutable proof
\href{https://github.com/sgstepaniants/OpenProblemsInNLA/tree/f488b0cfe2175e5e50d439c5a4115accc4b07b6d/nonnegative-and-positive-factorizations/NR-04/lean}{f488b0cf}.
...
\href{https://github.com/ajt60gaibb/OpenProblemsInNLA/blob/main/nonnegative-and-positive-factorizations/NR-04/lean/README.md}{Proof,
reproduction and scope} ·
\href{https://github.com/ajt60gaibb/OpenProblemsInNLA/blob/main/nonnegative-and-positive-factorizations/NR-04/lean/verification/linux-2026-09-19/SUMMARY.json}{Exact
execution evidence} ·
\href{https://github.com/ajt60gaibb/OpenProblemsInNLA/blob/main/nonnegative-and-positive-factorizations/NR-04/lean/formalization.yaml}{Formalization
metadata} ·
\href{https://github.com/ajt60gaibb/OpenProblemsInNLA/pull/304}{Upstream
PR \#304}.
