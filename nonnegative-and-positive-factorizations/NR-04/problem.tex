...
\operatorname{rank}_+(D)\le7\) and explicitly calls the exact value
open. Targeted searches for the nine-point linear Euclidean distance
matrix and subsequent nonnegative-rank results found no resolution. This
is a named unresolved benchmark in the source, rather than an arbitrary
specialization of a separately counted general problem.
\end{document}
