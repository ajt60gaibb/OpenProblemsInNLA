...
/-!
Exact C06 rational certificates for cone6: six restriction entries, all three
...
theorem seed_local_rational_certificate6 : SeedLocalRationalCertificate 6 := by
  refine ⟨?_, ?_, ?_, ?_, ?_⟩
  · intro a b hab k
...
#print axioms seed_local_rational_certificate6
#assert_trust kernel seed_local_rational_certificate6
