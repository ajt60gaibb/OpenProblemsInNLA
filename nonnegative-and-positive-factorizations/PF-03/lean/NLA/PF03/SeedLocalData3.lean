...
/-!
Exact C06 rational certificates for cone3: six restriction entries, all three
...
theorem seed_local_rational_certificate3 : SeedLocalRationalCertificate 3 := by
  refine ⟨?_, ?_, ?_, ?_, ?_⟩
  · intro a b hab k
...
#print axioms seed_local_rational_certificate3
#assert_trust kernel seed_local_rational_certificate3
