...
/-!
Exact C06 rational certificates for cone0: six restriction entries, all three
...
theorem seed_local_rational_certificate0 : SeedLocalRationalCertificate 0 := by
  refine ⟨?_, ?_, ?_, ?_, ?_⟩
  · intro a b hab k
...
#print axioms seed_local_rational_certificate0
#assert_trust kernel seed_local_rational_certificate0
