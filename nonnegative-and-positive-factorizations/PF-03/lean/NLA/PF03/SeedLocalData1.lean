...
/-!
Exact C06 rational certificates for cone1: six restriction entries, all three
...
theorem seed_local_rational_certificate1 : SeedLocalRationalCertificate 1 := by
  refine ⟨?_, ?_, ?_, ?_, ?_⟩
  · intro a b hab k
...
#print axioms seed_local_rational_certificate1
#assert_trust kernel seed_local_rational_certificate1
