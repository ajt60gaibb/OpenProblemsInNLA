...
/-!
Exact C06 rational certificates for cone2: six restriction entries, all three
...
theorem seed_local_rational_certificate2 : SeedLocalRationalCertificate 2 := by
  refine ⟨?_, ?_, ?_, ?_, ?_⟩
  · intro a b hab k
...
#print axioms seed_local_rational_certificate2
#assert_trust kernel seed_local_rational_certificate2
