...
/-!
Exact C06 rational certificates for cone5: six restriction entries, all three
...
theorem seed_local_rational_certificate5 : SeedLocalRationalCertificate 5 := by
  refine ⟨?_, ?_, ?_, ?_, ?_⟩
  · intro a b hab k
...
#print axioms seed_local_rational_certificate5
#assert_trust kernel seed_local_rational_certificate5
