...
\textbf{Remaining question:} The full prescribed-completion conjecture
for every \(n\ge4\) remains unresolved. The parity restriction is proved
only for a hypothetical factorization whose inner dimension equals
ordinary rank; it is not imposed on arbitrary wider factorizations. The
ratings assess that surviving question.
