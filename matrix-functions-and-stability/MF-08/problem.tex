...
\fancyfoot[L]{\parbox[b]{0.9\textwidth}{\sffamily\fontsize{8}{10}\selectfont\color{muted}Editorial ratings; a bounded search cannot certify that a problem remains unsolved.\\Literature check: 2026-09-18}}
...
\vspace{6pt}
\textbf{Historical rating rationale:} Extreme because this is a
longstanding complexity barrier for unrestricted feedback design; broad
impact connects control synthesis, optimization, and computational
complexity.

\subsection{Resolution --- 18 September
2026}\label{resolution-18-september-2026}

\textbf{Affirmative resolution.} Unrestricted static output-feedback
stabilization is NP-hard. Johan Löfberg proves this for integer
single-input plants in
\href{https://arxiv.org/html/2609.16886v1}{Theorem 1.1 of
arXiv:2609.16886v1}. Amir Ali Ahmadi, Abraar Chaudhry, Ijay Narang and
Yukai Tang prove strong NP-hardness for integer single-output plants in
\href{https://arxiv.org/html/2609.20636v1}{Theorem 1 of
arXiv:2609.20636v1}.

Each integer subclass is contained in the original rational-input
language: encode integers with denominator one, retaining the same
unrestricted real gain and the strict Hurwitz condition. Composing this
inclusion with either paper's polynomial-time many-one reduction settles
the retained question. The theorem credit belongs to the cited authors.

\textbf{Review level.} These are v1 preprints submitted on 15 and 17
September 2026. A separate Codex-agent review examined both complete
continuous-time arguments and their match to this problem; no
substantive gap was found. This is informal review, with no claim of
journal acceptance, external human peer review or Lean verification.
\href{https://github.com/ajt60gaibb/OpenProblemsInNLA/blob/main/references/stepaniants-mf08-2026-09-18/README.md}{Reference
note and review scope}.

\textbf{Literature application and curation:} George Stepaniants,
Department of Computing and Mathematical Sciences, California Institute
of Technology. The difficulty and importance ratings above are
historical. The original statement and the 10 September audit are
retained.
