...
\vspace{6pt}
\textbf{Status:} open; explicitly retained in a 2025 follow-up
...
3×3 binary matrices}, §3 and Theorem 3.1 (2025 preprint), treats the
all-dimensions problem as open while proving the binary-pair case in
