...
pub = repo/'matrix-inequalities-and-norms/MI-03/lean/verification/publication-2026-09-12'
env = os.environ.copy()
...
commands = [
    ...
    ('manifest',['/tmp/nla-lean-formalization/venv/bin/python','tools/lean/validate_manifest.py','matrix-inequalities-and-norms/MI-03/lean']),
    ('format-write',['python3','tools/format_math.py','--write','MI-03']),
    ...
    ('render',['python3','tools/render_problems.py','MI-03']),
    ('pdfinfo',['pdfinfo','matrix-inequalities-and-norms/MI-03/problem.pdf']),
]
checks = []
