...
\textbf{Rating rationale:} The all-order assertion is a longstanding
sharp permanent inequality; its immediate implications are concentrated
in stochastic-matrix permanent theory.
...
\textbf{Audit update (2026-09-10):} Rechecked the published Theorems
2.1--2.2, rather than substituting the broader preprint abstract, and
searched for later Lih--Wang resolutions. Order four and the restricted
order-six result leave the general target unresolved. This is a bounded
