---
title: "MI-06 — Thompson-type domination for the arithmetic symmetric modulus"
...
proof-source: "../../references/colbrook-matrix-2026-09-11/original-proofs/MI-06.tex"
...
review-source: "../../references/colbrook-matrix-2026-09-11/verification/reviews/MI-06-review.md"
---
...
The complete authored proof is in [solution.pdf](solution.pdf) and its [standalone LaTeX source](solution.tex), **Theorem 1.1 and its proof**. This Markdown page is a submission note; the complete mathematical argument is the attached TeX/PDF. The [original proof](../../references/colbrook-matrix-2026-09-11/original-proofs/MI-06.tex) is embedded unchanged in the exported TeX.

A separate Codex agent returned [PASS](../../references/colbrook-matrix-2026-09-11/verification/reviews/MI-06-review.md) after checking the complete original argument against the exact catalog target. The full original SHA-256 after UTF-8 decoding and CRLF-to-LF normalization, without trimming, is `1324c6ecd4a845e6782081e79d401a9dd59612463e40b7ecc176a9ea9003c1e9`. The original draft was AI-assisted. Independent agent verification is not external human peer review or formal proof certification, and the review does not certify novelty or first-discovery priority.
