...
For a complex square matrix $X$, write $|X|=(X^*X)^{1/2}$ and $\|X\|_p=(\operatorname{tr}|X|^p)^{1/p}$. For every integer $m\ge2$ and real $1<p<2$, determine exactly the dimension-independent constant
