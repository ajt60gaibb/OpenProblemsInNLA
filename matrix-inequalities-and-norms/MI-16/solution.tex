...
\hypersetup{pdftitle={MI-16: an exact algebraic determination and a sharp exceptional-spectrum formula},pdfauthor={Sidney Holden},pdfsubject={Maximum permanent on positive-semidefinite unitary orbits}}
\begin{document}
\begin{titlepage}
\vspace*{0mm}
