...
\vspace{6pt}
\textbf{Rating rationale:} The all-block-count inequality is a
longstanding permanent conjecture; its immediate payoff is the
specialized theory of PSD block permanents.
...
\textbf{Audit update (2026-09-10):} Rechecked Wanless Conjecture 3 and
its following paragraph. The \(m=2\) theorem and a real-matrix regime
are partial cases; later searches for the permanent-of-permanents
inequality found no unrestricted resolution. This is a bounded
