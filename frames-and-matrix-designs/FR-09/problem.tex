...
The supplied rational certificates independently pass the exact interval
contraction test in dimensions \(d=166,209,256,1505\). The accompanying
proof, Sections 1-4, constructs Hermitian conference matrices of order
\(2d\) and hence unit-norm complex equiangular tight frames with \(2d\)
vectors. This records four certified instances, not all dimensions or an
asserted priority claim. The other 88 dimensions appearing only in the
supplied catalog report lack certificates in this archive and are not
certified by this submission.

See the
\href{https://github.com/ajt60gaibb/OpenProblemsInNLA/blob/main/references/colbrook-frames-2026-09-11/conference-proof.md}{certificate
proof},
\href{https://github.com/ajt60gaibb/OpenProblemsInNLA/blob/main/references/colbrook-frames-2026-09-11/verification/reviews/FR-09-review.md}{independent
agent review}, and
