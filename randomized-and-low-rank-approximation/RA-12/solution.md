---
title: "RA-12: the relative-error threshold for extremal Gaussian trace bounds"
...
**Verification status: independent-agent PASS.** This manuscript proves the complete canonical RA-12 comparison, with both tails controlled at the stated threshold. It was developed with substantial ChatGPT/Codex assistance. A separate agent independently checked the entire proof, the exact target, the external unimodality theorem and all endpoints. [Detailed independent review](../../references/stepaniants-ra12-2026-09-11/verification/RA-12-independent-review.md).

The [submission record](../../references/stepaniants-ra12-2026-09-11/README.md) preserves the frozen draft and its exact hashes. The mathematical core below is unchanged from that reviewed draft. Verification is independent automated-agent review, not external human peer review or formal proof certification. The published Gamma-convolution unimodality theorem and Hallman's coefficient-derivative method retain their attribution.
