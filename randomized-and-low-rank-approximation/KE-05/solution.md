...
This manuscript gives a negative resolution of the original KE-05 probability bound. The conjecture and interpolation framework are due to Nian Shao. The proof uses the fixed canonical recurrence and deterministic real diagonal inputs.

**Review and assistance.** The [independent mathematical review](../../references/stepaniants-ke05-2026-09-12/independent-review.md) and [submission record](../../references/stepaniants-ke05-2026-09-12/README.md) document the reviewed source and verification scope. The manuscript was developed with substantial AI assistance. An independent AI-agent audit is informal review; it does not establish external human peer review or formal verification. The coordinating agent contributed to the argument and is not counted as the independent reviewer.
...
The linked independent review and public eligibility audit document the
separate mathematical and publication checks.

## Primary references

1. Canonical KE-05, *Spectral-gap-independent constants for randomized
   block polynomial interpolation*:
   <https://github.com/ajt60gaibb/OpenProblemsInNLA/blob/main/randomized-and-low-rank-approximation/KE-05/README.md>.
