---
title: "RA-19: Critical-point count for corank-one approximation with one fixed zero"
...
review-footer: "AI-assisted proof; review status and exact-source evidence are documented in the submission record."
---
...
This manuscript proves the full all-dimension target of RA-19, the conjecture of Kubjas, Sodomaco and Tsigaridas [KST22, Conjecture 5.1]. It was developed with substantial ChatGPT/Codex assistance at the author's request. A separate [independent Codex-agent review](../../references/stepaniants-ra19-2026-09-11/verification/independent-review/review.md) returned PASS for the complete target; a [coordinating-agent audit](../../references/stepaniants-ra19-2026-09-11/verification/RA-19-root-math-review.md) also found no gap. No external human peer review, formal proof-assistant verification, or priority determination is asserted. The [submission record](../../references/stepaniants-ra19-2026-09-11/README.md) preserves the original proof and verification evidence.
...
## 7. Reference and verification scope

**[KST22]** K. Kubjas, L. Sodomaco and E. Tsigaridas, *Exact solutions in low-rank approximation with zeros*, Linear Algebra and its Applications **641** (2022), 67-97. [DOI: 10.1016/j.laa.2022.01.021](https://doi.org/10.1016/j.laa.2022.01.021); [arXiv:2010.15636v2](https://arxiv.org/abs/2010.15636v2), 29 January 2022. Conjecture 5.1 and Table 2, manuscript page 19; Section 2 defines the bilinear distance and smooth-locus critical points.

The source's formula $5(n-1)-2$ equals $5n-7$. Its computations for orders 3-10 are finite evidence and are not a premise of this proof. The original canonical statement already excludes dimension two, for the reason in Section 6.

A separate reviewer-written [universal polynomial checker](../../references/stepaniants-ra19-2026-09-11/verification/independent-review/universal_algebra_check.py) verifies the reduction and resultant identities over the formal integer polynomial ring in $f,g,h,f',g',h'$. It supports the algebraic calculation in every dimension and does not formally certify the geometric or genericity arguments.

The [exact supplemental checker](../../references/stepaniants-ra19-2026-09-11/verification/exact_check.py) separately evaluates the Sylvester and characteristic determinants on explicit integer data for orders 2-6. It checks the displayed eliminant identity, degree, squarefreeness and exceptional-locus exclusions in those finite examples. The universal theorem follows from Sections 1-5, including the all-dimension nonempty-open-set witness and the generic reducedness argument; finite checks do not establish the theorem by themselves.

The public-source audit at 00:40:42 UTC on 12 September 2026 covered five public repositories and all 37 branch heads. RA-19 was Open wherever its canonical page was present; older heads lacked the newly admitted entry. The only matching discussion was its admission PR 111. The current arXiv record still lists version 2, and bounded later-solution searches found no full resolution. Private, deleted, unpublished, or unidentifiably named work is outside that search. The full dated scope and source hashes are in the submission record.
