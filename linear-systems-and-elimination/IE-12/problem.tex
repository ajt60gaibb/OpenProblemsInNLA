...
\vspace{6pt}
\textbf{Rating rationale:} Challenging reflects the remaining removal of
a dimension-dependent logarithm from an established general algorithm;
broad impact follows from a condition-independent cost bound for
