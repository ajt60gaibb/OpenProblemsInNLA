...
\usepackage{bookmark}
\usepackage{xurl}
\hypersetup{colorlinks=true,urlcolor=blue,linkcolor=blue,pdftitle={IE-04:
A rare-event obstruction to the uniform exponential GEPP
tail},pdfauthor={George Stepaniants},pdflang={en-GB}}
\urlstyle{same}
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\sffamily RESOLUTION / IE-04}
...
\begin{document}
{\raggedright\Large\bfseries IE-04: A rare-event obstruction to the
uniform exponential GEPP tail\par}
\vspace{0.4em}
...
This manuscript gives a negative resolution of the complete IE-04
inequality. The
...
complete-proof review} returned PASS on the recovered source. This is
AI-assisted work with independent automated-agent review; no external
human peer review, formal proof-assistant certification, or novelty
determination is claimed. The
\href{https://github.com/ajt60gaibb/OpenProblemsInNLA/blob/main/references/stepaniants-ie04-2026-09-11/README.md}{submission
record} preserves the supplied draft, exact checks, and public
eligibility evidence.

\subsection{Statement and conclusion}\label{statement-and-conclusion}
...
\subsection{A strictly pivoted high-growth
...
\subsection{Quantitative robustness on a full entrywise
...
\subsection{Gaussian probability of the
...
\subsection{Contradiction for arbitrary proposed
...
\subsection{Verification, scope, and
...
recovery. The argument was developed with substantial ChatGPT/Codex
assistance at the author's request. A separate independent Codex-agent
review returned PASS for the complete canonical target; the signed
report is preserved in the submission record. No external human peer
review, formal proof-assistant certification, or novelty/priority
