...
**Conjecture (van der Houwen–de Swart).** For every such node set, does there exist a real positive diagonal matrix $D=\operatorname{diag}(d_1,\ldots,d_s)$ such that
