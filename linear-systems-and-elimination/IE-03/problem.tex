...
\vspace{6pt}
\textbf{Rating rationale:} Extreme reflects a longstanding conjecture
across every Hadamard order and pivot path; community impact comes from
sharp complete-pivoting stability and its connection to Hadamard
structure.
...
The
\href{https://www.tandfonline.com/doi/abs/10.1080/03081087.2026.2660796}{2026
butterfly paper}, §3, retains the general Hadamard conjecture while
recording proofs for Sylvester-type matrices in all their orders and
every Hadamard matrix of order at most 16. Hence the status now records
partial resolution. Searches for Cryer/Hadamard growth and later
complete-pivoting results found no general proof or counterexample;
asymptotic bounds for unrestricted matrices do not settle this subclass.
\end{document}
