...
author_receipt=root/'reviews/projection-event-author-evidence/receipt.json'
author=json.loads(author_receipt.read_text())
energy_receipt=root/'reviews/gaussian-energy-author-evidence/receipt.json'
expected={**json.loads(energy_receipt.read_text())['source_sha256'],**author['source_sha256'],**author['consumed_dependency_sha256']}
...
assert len(deps)==31
build=Path(tempfile.mkdtemp(prefix='nla-ie22-energy-event-referee-',dir='/private/tmp'))
...
sources=['NLA/IE22/Definitions.lean','NLA/IE22/TrimmingThreshold.lean','NLA/IE22/GaussianMean.lean','NLA/IE22/GaussianEnergy.lean','NLA/IE22/VarianceTensorization.lean','NLA/IE22/GaussianPoincare.lean','NLA/IE22/GaussianPoincareHinge.lean','NLA/IE22/GaussianVariance.lean','NLA/IE22/ProjectionEvent.lean','reviews/energy-event-referee-infrastructure-evidence/ExactTypesAndAxioms.lean']
...
names=[n for f in (sources[3:4]+sources[8:9]) for n in re.findall(r'^(?:theorem|lemma) ([A-Za-z0-9_]+)',(root/f).read_text(),re.M)]
