...
if localcert.is_dir():
 blob=subprocess.check_output(['git','show',pins['leancert'][1]+':LeanCert/Tactic/Verification.lean'],cwd=localcert)
 check(blob==(E/'dependency-evidence/LeanCert-Verification.lean').read_bytes(),'LeanCert evidence matches independent pinned Git blob')
