...
p.add_argument('--guest-directory',default='/home/admin/nla-ie22-full-20260922')
...
assert r['project_path']=='linear-systems-and-elimination/IE-22/lean'
...
assert len(r['theorem_names'])==len(set(r['theorem_names']))==20
...
assert a.guest_directory.startswith('/home/admin/nla-ie22-full-') and '..' not in PurePosixPath(a.guest_directory).parts
def guest(code):
