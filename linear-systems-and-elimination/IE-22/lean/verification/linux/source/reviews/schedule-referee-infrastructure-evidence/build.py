...
expected={'NLA/IE22/DeterministicSchedule.lean':digest(root/'NLA/IE22/DeterministicSchedule.lean')}
...
assert len(deps)==31
build=Path(tempfile.mkdtemp(prefix='nla-ie22-schedule-referee-',dir='/private/tmp'))
...
sources=['NLA/IE22/Definitions.lean','NLA/IE22/DeterministicSchedule.lean','reviews/schedule-referee-infrastructure-evidence/ExactTypesAndAxioms.lean']
...
names=[n for f in sources[1:2] for n in re.findall(r'^(?:theorem|lemma) ([A-Za-z0-9_]+)',(root/f).read_text(),re.M)]
