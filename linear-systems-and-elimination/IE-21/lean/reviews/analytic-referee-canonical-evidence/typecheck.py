#!/usr/bin/env python3
"""Independent module review build; never imports Challenge or active GaussianMoments."""
from pathlib import Path
import os, subprocess, tempfile, json, hashlib
root=Path(__file__).resolve().parents[2]
evidence=Path(__file__).resolve().parent
build=Path(tempfile.mkdtemp(prefix='nla-ie21-analytic-independent-',dir='/private/tmp'))
...
files=['NLA/IE21/Definitions.lean', 'NLA/IE21/GaussianTrimming.lean', 'NLA/IE21/PopulationTrimming.lean', 'NLA/IE21/SphericalLaw.lean', 'NLA/IE21/RowLaw.lean', 'NLA/IE21/GaussianPolar.lean', 'NLA/IE21/AspectSchedule.lean', 'reviews/analytic-referee-canonical-evidence/SignatureCheck.lean', 'reviews/analytic-referee-canonical-evidence/Axioms.lean']
results=[]
