#!/usr/bin/env python3
"""Development-only proof-module typecheck; not full verification."""
...
build = Path('/private/tmp/nla-ie21-uniform-trimming-helper-final-build')
...
with (evidence / 'development-typecheck.log').open('w') as log:
    ...
    for file in (sys.argv[1:] or ['NLA/IE21/Definitions.lean', 'NLA/IE21/MatrixSemantics.lean', 'NLA/IE21/FiniteTrimming.lean', 'NLA/IE21/SphereNet.lean', 'NLA/IE21/QuadraticNet.lean', 'NLA/IE21/UniformTrimmingGeometry.lean', 'NLA/IE21/UniformTrimmingBound.lean', 'reviews/uniform-trimming-author-evidence/Axioms.lean']):
