#!/usr/bin/env python3
"""Independent selected covariance and MGF review; never imports Challenge."""
from pathlib import Path
import os, subprocess, tempfile, json, hashlib
root=Path(__file__).resolve().parents[2]
evidence=Path(__file__).resolve().parent
build=Path(tempfile.mkdtemp(prefix='nla-ie21-covariance-selected-independent-',dir='/private/tmp'))
...
files=['NLA/IE21/Definitions.lean', 'NLA/IE21/MatrixSemantics.lean', 'NLA/IE21/FiniteTrimming.lean', 'NLA/IE21/SphereNet.lean', 'NLA/IE21/SphericalLaw.lean', 'NLA/IE21/RowLaw.lean', 'NLA/IE21/GaussianPolar.lean', 'NLA/IE21/GaussianMoments.lean', 'NLA/IE21/SphericalMoments.lean', 'NLA/IE21/QuadraticNet.lean', 'NLA/IE21/Chernoff.lean', 'NLA/IE21/CovarianceConcentration.lean', 'NLA/IE21/SphericalMGF.lean', 'NLA/IE21/Covariance.lean', 'reviews/covariance-selected-referee-canonical-evidence/SignatureCheck.lean', 'reviews/covariance-selected-referee-canonical-evidence/Axioms.lean']
