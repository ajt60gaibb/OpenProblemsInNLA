...
build=Path(tempfile.mkdtemp(prefix='nla-ie21-final-assigned-milestone-'))
...
files=['NLA/IE21/Definitions.lean','NLA/IE21/GaussianTrimming.lean','NLA/IE21/PopulationTrimming.lean','NLA/IE21/QuantileTrimming.lean','NLA/IE21/MatrixSemantics.lean','NLA/IE21/FiniteTrimming.lean','NLA/IE21/EmpiricalTrimming.lean','NLA/IE21/BoundedConcentration.lean','NLA/IE21/TrimmingConcentration.lean','NLA/IE21/SphericalLaw.lean','NLA/IE21/RowLaw.lean','NLA/IE21/GaussianPolar.lean','NLA/IE21/GaussianMoments.lean','NLA/IE21/SphericalMoments.lean','NLA/IE21/SphericalTrimming.lean','NLA/IE21/SphereNet.lean','NLA/IE21/QuadraticNet.lean','NLA/IE21/PointwiseTrimmingSemantics.lean','NLA/IE21/PointwiseTrimming.lean','reviews/gaussian-trimming-author-evidence/FinalAxioms.lean']
records=[]
with (evidence/'final-assigned-typecheck.log').open('w') as log:
...
log_text=(evidence/'final-assigned-typecheck.log').read_text()
...
receipt={'milestone':'three exact assigned Gaussian and pointwise trimming targets',
 'scope':'gaussian_constant, spherical_gaussian_trimming, pointwise_trim_concentration author completion; full IE-21 campaign gates not run',
 ...
 'log_sha256':hashlib.sha256((evidence/'final-assigned-typecheck.log').read_bytes()).hexdigest()}
(evidence/'final-assigned-author-evidence.json').write_text(json.dumps(receipt,indent=2)+'\n')
print('Evidence saved; three assigned targets plus prerequisite sphere_net axiom closures allowed. Build:',build,flush=True)
