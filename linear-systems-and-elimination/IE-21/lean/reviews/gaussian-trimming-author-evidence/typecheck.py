...
build=Path(tempfile.mkdtemp(prefix='nla-ie21-gaussian-milestone-'))
...
files=['NLA/IE21/Definitions.lean','NLA/IE21/GaussianTrimming.lean',
 'reviews/gaussian-trimming-author-evidence/Axioms.lean']
records=[]
...
log_text=(evidence/'development-typecheck.log').read_text()
...
receipt={'milestone':'exact gaussian_constant and three Gaussian integral helpers',
 'scope':'partial IE-21 author development evidence; 1 of 23 frozen targets implemented here',
 ...
 'log_sha256':hashlib.sha256((evidence/'development-typecheck.log').read_bytes()).hexdigest()}
(evidence/'author-evidence.json').write_text(json.dumps(receipt,indent=2)+'\n')
print('Evidence saved; four public axiom closures allowed. Build:',build,flush=True)
