...
publication=Path('/private/tmp/nla-ie21-publication-20260922')
...
cmd=[TART,'exec','mf21-verification','/usr/bin/python3','/home/admin/nla-ie21-full-20260922/prepare-guest.py']
...
assert prep['tracked_input_count']==len(input_receipt['input_sha256'])==289
assert prep['selected_theorem_count']==23
...
cmd=[TART,'exec','mf21-verification','/usr/bin/env','XDG_RUNTIME_DIR=/run/user/1000','DBUS_SESSION_BUS_ADDRESS=unix:path=/run/user/1000/bus','systemd-run','--user','--unit=nla-ie21-full-20260922-r1','-p','RuntimeMaxSec=5400','-p','LimitNOFILE=65536','--working-directory=/home/admin/nla-ie21-full-20260922','/usr/bin/python3','/home/admin/nla-ie21-full-20260922/run-verifier.py']
p=subprocess.run(cmd,env=env,text=True,stdout=subprocess.PIPE,stderr=subprocess.STDOUT)
