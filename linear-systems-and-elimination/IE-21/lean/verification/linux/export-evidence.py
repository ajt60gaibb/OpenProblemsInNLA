...
guest_base='/home/admin/nla-ie21-full-20260922'
...
dest=Path('/private/tmp/nla-ie21-publication-20260922/linear-systems-and-elimination/IE-21/lean/verification/linux')
...
record={'source':'successful-verification/comparator.log','source_sha256':hashlib.sha256((dest/'successful-verification/comparator.log').read_bytes()).hexdigest(),'exports':[{'module':module,'all_logged_declarations':declarations.split(', '),'selected_declarations':[n for n in declarations.split(', ') if n.startswith('NLA.IE21.')]} for declarations,module in exports],'selected_theorem_count':len(selected),'raw_stream_scope':'Pinned Comparator removes temporary raw export streams; no retained stream hashes are claimed.'}
