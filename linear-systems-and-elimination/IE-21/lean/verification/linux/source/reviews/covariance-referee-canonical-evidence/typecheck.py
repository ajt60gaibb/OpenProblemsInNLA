#!/usr/bin/env python3
"""Independent covariance helper review; never imports Challenge or SphericalMGF."""
from pathlib import Path
import os, subprocess, tempfile, json, hashlib
root=Path(__file__).resolve().parents[2]
evidence=Path(__file__).resolve().parent
build=Path(tempfile.mkdtemp(prefix='nla-ie21-covariance-independent-',dir='/private/tmp'))
...
files=['NLA/IE21/Definitions.lean', 'NLA/IE21/MatrixSemantics.lean', 'NLA/IE21/FiniteTrimming.lean', 'NLA/IE21/SphereNet.lean', 'NLA/IE21/SphericalLaw.lean', 'NLA/IE21/RowLaw.lean', 'NLA/IE21/QuadraticNet.lean', 'NLA/IE21/Chernoff.lean', 'NLA/IE21/CovarianceConcentration.lean', 'NLA/IE21/RatioAlgebra.lean', 'reviews/covariance-referee-canonical-evidence/SignatureCheck.lean', 'reviews/covariance-referee-canonical-evidence/Axioms.lean']
