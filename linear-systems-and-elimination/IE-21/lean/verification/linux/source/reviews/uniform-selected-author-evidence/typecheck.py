#!/usr/bin/env python3
"""Author audit of the exact frozen uniform target; no whole-problem verification claim."""
from pathlib import Path
import os, subprocess, tempfile, json, hashlib
root=Path(__file__).resolve().parents[2]
evidence=Path(__file__).resolve().parent
build=Path(tempfile.mkdtemp(prefix='nla-ie21-uniform-selected-author-',dir='/private/tmp'))
...
files=['NLA/IE21/Definitions.lean', 'NLA/IE21/MatrixSemantics.lean', 'NLA/IE21/FiniteTrimming.lean', 'NLA/IE21/SphereNet.lean', 'NLA/IE21/QuadraticNet.lean', 'NLA/IE21/UniformTrimmingGeometry.lean', 'NLA/IE21/UniformTrimmingBound.lean', 'NLA/IE21/SphericalLaw.lean', 'NLA/IE21/RowLaw.lean', 'NLA/IE21/Chernoff.lean', 'NLA/IE21/CovarianceConcentration.lean', 'NLA/IE21/GaussianPolar.lean', 'NLA/IE21/GaussianMoments.lean', 'NLA/IE21/SphericalMoments.lean', 'NLA/IE21/SphericalMGF.lean', 'NLA/IE21/Covariance.lean', 'NLA/IE21/GaussianTrimming.lean', 'NLA/IE21/PopulationTrimming.lean', 'NLA/IE21/SphericalTrimming.lean', 'NLA/IE21/QuantileTrimming.lean', 'NLA/IE21/EmpiricalTrimming.lean', 'NLA/IE21/BoundedConcentration.lean', 'NLA/IE21/TrimmingConcentration.lean', 'NLA/IE21/PointwiseTrimmingSemantics.lean', 'NLA/IE21/PointwiseTrimming.lean', 'NLA/IE21/UniformTrimming.lean', 'reviews/uniform-selected-author-evidence/SignatureCheck.lean', 'reviews/uniform-selected-author-evidence/Axioms.lean']
...
with (evidence/'typecheck.log').open('w') as log:
 log.write('Author selected module audit; not independent or full IE-21 verification.\n')
