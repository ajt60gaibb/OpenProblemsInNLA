---
title: "IE-02: Ideal and worst-case GMRES coincide for a Jordan block"
...
This manuscript proves the full complex Jordan-block equality in IE-02. It was developed with substantial ChatGPT/Codex assistance at the author's request. A separate [independent Codex-agent review](../../references/stepaniants-ie02-2026-09-11/verification/IE-02-independent-review.md) returned PASS for the complete target. This is automated-agent review; no external human peer review or formal proof-assistant verification is asserted.

The argument proves a stronger statement for finite affine families of triangular Toeplitz matrices. It uses finite Carathéodory–Fejér interpolation and scalar polynomial spectral factorization, with no simplicity, divisibility, or eigenvalue-regime restriction.
...
Theorem 1 establishes the exact original target for all dimensions, every allowed degree, all nonzero complex eigenvalues, and complex polynomials and starting vectors. Theorem 6 also proves the affine minimax equality for triangular Toeplitz matrices. The proof does not change the matrix or use a doubled dimension.

The classical finite Carathéodory–Fejér theorem is the only external analytic input. The scalar factorization, maximal singular-subspace description, finite-dimensional optimality condition, and preservation of all complex orthogonality equations are proved here. The [submission record](../../references/stepaniants-ie02-2026-09-11/README.md) preserves the exact research source and documents independent review and source-conversion checks.
