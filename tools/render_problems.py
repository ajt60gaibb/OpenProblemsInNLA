...
def render(source):
    ...
    with tempfile.TemporaryDirectory(prefix=f"nla-{identifier}-") as work:
        ...
        if identifier in {
            'AA-01', 'AC-13', 'AV-02', 'AV-03', 'FR-01', 'FR-02', 'FR-04', 'FR-10',
            'FR-11', 'IE-03', 'IE-06', 'IE-08', 'IE-11', 'IE-13', 'IE-19', 'IE-21',
            'IE-22', 'IE-24', 'IE-25', 'IS-02', 'IS-03', 'IS-05', 'IV-02', 'IV-04',
            'IV-05', 'IV-06', 'KE-03', 'KE-04', 'KE-05', 'MF-14', 'MF-15', 'MF-16',
