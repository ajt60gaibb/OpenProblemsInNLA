...
def render(source):
    ...
    with tempfile.TemporaryDirectory(prefix=f"nla-{identifier}-") as work:
        ...
        if identifier in {
            'AA-01', 'AC-13', 'AV-01', 'AV-02', 'AV-03', 'IV-03', 'FR-01', 'IE-24', 'IE-25', 'IE-03', 'IE-06',
            ...
            'MI-03', 'MI-04', 'MI-06', 'MI-07', 'MI-08', 'MI-09', 'MI-19', 'MI-23', 'MI-29',
            'RA-08', 'RA-09', 'RA-10', 'RA-11', 'RA-12', 'RA-14',
            'RA-15', 'RA-17', 'RE-01', 'RE-02', 'RE-03', 'RE-06',
