...
def render(source):
    ...
    with tempfile.TemporaryDirectory(prefix=f"nla-{identifier}-") as work:
        ...
        if identifier in {
            ...
            'KE-05', 'MF-14', 'MF-15', 'MF-16', 'MF-17', 'MF-21', 'MI-03', 'MI-04',
            'MI-06', 'MI-07', 'MI-08', 'MI-09', 'MI-19', 'MI-23', 'MI-29', 'NM-01',
            'NM-03', 'PF-05', 'RA-02', 'RA-04', 'RA-06', 'RA-08', 'RA-09', 'RA-10',
            'RA-11', 'RA-12', 'RA-14', 'RA-15', 'RA-17', 'RE-01', 'RE-02', 'RE-03',
            'RE-06', 'SP-04', 'SP-05', 'SP-06', 'SP-07', 'SP-09', 'SP-12', 'TR-11',
            'TR-20', 'TR-21', 'TR-24', 'TR-26', 'TR-30',
        }:
