...
\vspace{6pt}
\textbf{Rating rationale:} Challenging reflects a sharp perturbation
threshold without geometric separation assumptions beyond a spectral
gap; community impact is the stability of spectral subspaces.
...
Rechecked \href{https://arxiv.org/pdf/1412.6294}{Seelmann's primary
account} and the
\href{https://files.ele-math.com/articles/oam-15-74.pdf}{2021
perturbation paper}. The generic sharp threshold remains distinct from
the established sufficient constants and stronger results under extra
geometry. Searches for subsequent optimal generic subspace-rotation
thresholds found no solution; these nonsharp estimates do not complete
the displayed optimum.
\end{document}
