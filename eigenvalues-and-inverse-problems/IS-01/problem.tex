...
\vspace{6pt}
\textbf{Rating rationale:} Challenging reflects a global
spectral-boundary description using a restricted combinatorial family;
community impact connects stochastic matrices, inverse spectra, and
convex geometry.
...
Rechecked the \href{https://arxiv.org/abs/1908.03647}{Boundary
Conjecture source} and the
\href{https://ilas2026.math.vt.edu/docs/ILAS2026-Book-Of-Abstracts.pdf}{ILAS
2026 abstracts}, p.~150. The latter reports further computational
exploration, not a general proof. Searches for subsequent doubly
stochastic spectral-boundary results found no resolution; the refuted
Perfect--Mirsky conjecture is a different claim.
\end{document}
