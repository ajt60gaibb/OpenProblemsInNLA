---
title: "SP-13: Trace-norm-small perturbations preserve Hermitian spectral distributions"
...
review-footer: "AI-assisted proof; the exact-source reviews and their limits are documented in the submission record."
---

This manuscript proves the complete Barbarino-Serra-Capizzano trace-norm perturbation conjecture. It was developed with substantial ChatGPT/Codex assistance at the author's request. A separate [independent Codex-agent mathematical review](../../references/stepaniants-sp13-2026-09-11/verification/SP-13-independent-review.md) returned PASS for the complete target; a [coordinating-agent audit](../../references/stepaniants-sp13-2026-09-11/verification/SP-13-root-math-review.md) also found no gap. No external human peer review, formal proof-assistant verification, or priority determination is asserted. The [submission record](../../references/stepaniants-sp13-2026-09-11/README.md) preserves the frozen source, original target and verification evidence.
...
The published weak-type theorem retains its attribution to Randrianantoanina and Dodds, Dodds, de Pagter and Sukochev. Barbarino and Serra-Capizzano retain credit for the conjecture and preceding perturbation results. This proof applies the dimension-independent triangular-truncation estimate to the imaginary Hermitian part of a Schur form.
