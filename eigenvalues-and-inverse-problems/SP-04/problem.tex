...
The manuscript claims that the stationary pair with uniquely smallest
absolute multiplier fails to minimize the Frobenius distance for an open
set of real \(3\times3\) data matrices with distinct singular values in
\((7/4,44/25)\). Both determinant signs are allowed. The open-set
argument addresses the algebraic-generic qualifier in the original
target.
