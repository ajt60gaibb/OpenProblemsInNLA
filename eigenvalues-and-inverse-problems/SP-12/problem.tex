...
\vspace{6pt}
\textbf{Rating rationale:} Challenging reflects the need for a stronger
general PSD/SAP realization bound than current connectivity estimates
supply; implication from Hadwiger does not establish equivalent
difficulty. Specialist impact reflects the focus on this particular
graph nullity invariant.
