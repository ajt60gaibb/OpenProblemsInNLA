...
| Forsythe conjecture at restart length two | Colbrook, Stepaniants, and Townsend, [August 2026 preprint](https://arxiv.org/abs/2608.02852). | The admitted IE-01 states only the surviving range of restart lengths. |
...
| Relative-error least squares and SVD after an oblivious column subset | Townsend and Wang, [*Oblivious Column Subsampling*](https://arxiv.org/html/2604.10215v2), §§3.1 and 4.1; August 2026 revision. | Historical broad versions are resolved. Source section locators were checked directly. |
| Nyström monotonicity for SDDM and SDD matrices | Colbrook, [July 2026 manuscript](https://arxiv.org/abs/2607.19282). | Positive SDDM theorem and an SDD counterexample exclude both historical questions. |
