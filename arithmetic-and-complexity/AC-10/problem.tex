...
\vspace{6pt}
\textbf{Rating rationale:} Extreme because an explicit family at
Valiant's rank scale would break a longstanding linear-circuit
lower-bound barrier; broad importance connects sparse perturbations,
matrix structure and computational complexity.\\
...
Rechecked \href{https://arxiv.org/html/2502.19580v1}{Alman--Liang, §1}
and the
\href{https://drops.dagstuhl.de/entities/document/10.4230/LIPIcs.ICALP.2026.106}{ICALP
2026 spiky-rank paper}, and searched for explicit rational Valiant-rigid
constructions. The former's low-rank bounds and conditional
amplification do not meet the displayed n/log-log-n rank scale. No
polynomial-time rational family meeting the target was located. The
conclusion concerns rigidity over the rationals; results in other fields
or for random matrices require a separate comparison.
\end{document}
