...
\vspace{6pt}
\textbf{Rating rationale:} Extreme because the unrestricted inequality
is a longstanding frontier of addition-chain theory despite many proved
structured cases; specialist importance reflects the multiplication-only
powering model.\\
...
Added \href{https://doi.org/10.1007/s00026-026-00816-y}{Wallner, The
Decompressed Tree Size of k-Ary Chains, §7}, published April 2026, which
still identifies Scholz--Brauer as an open conjecture. Searches for full
proofs found structured-chain and almost-all-integer claims, not the
universal result; \href{https://eprint.iacr.org/2024/1199.pdf}{Agama's
2024 introduction} recalls Brauer's proved star-optimal subclass.
Clift's counterexample concerns equality, not this upper bound. The
\href{https://doi.org/10.4236/am.2016.71006}{2016 ``First Conjecture''
paper} concerns elementary binary-length bounds, a different statement.
\end{document}
