...
\hypersetup{
  ...
  pdfauthor={George Stepaniants; prepared with ChatGPT}
}
\pagestyle{fancy}
\fancyhf{}
...
conversation with ChatGPT.  A separate Codex agent independently reviewed
the proof on 11 September 2026.  This review is not human peer review or
a formal verification certificate.  All model-specific lemmas are proved below; the only external
...
steps but remains a proposed proof pending human peer review or formal
verification.
