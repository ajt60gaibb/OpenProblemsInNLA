...
Exact restricted-family witnesses and exhaustive unrestricted-range
inclusion checks establish equality of the signed permanent ranges for
every order \(1\leq n\leq10\). Entries below the diagonal are \(+1\),
and negative diagonal entries are allowed, exactly as in the original
target. Both witness membership and exhaustive inclusion are checked.
The all-orders assertion, including orders \(n\geq11\), remains
unresolved.
