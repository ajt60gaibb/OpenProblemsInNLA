...
**14 problems with open targets.**

| ID | Problem | Status | Difficulty | Impact | Read / source |
| --- | --- | --- | --- | --- | --- |
| [AA-01](AA-01/README.md) | Deciding accurate evaluability of real polynomials | **🔵 OPEN** | extreme | broadly interesting | [PDF](AA-01/problem.pdf) · [TeX](AA-01/problem.tex) |
