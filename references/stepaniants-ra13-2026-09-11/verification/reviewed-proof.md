# RA-13: a proposed full absolute-error Gaussian trace-tail comparison

George Stepaniants  
Department of Computing and Mathematical Sciences, California Institute of Technology  
11 September 2026

**Status: new proof candidate, awaiting independent review.** No canonical page has been changed and no resolution has been published. The argument below proves a stronger one-sided comparison, if all its steps withstand review. It uses the published weak bell-shape theorem of Kwaśnicki; the inflection-location identity and the grouped coefficient transfers are supplied here.
...
1. Eric Hallman, *Extremal bounds for Gaussian trace estimation*, arXiv:2411.15454v1, Theorem 7 and Conjecture 4; Appendix A.2 supplies the centered square-transfer derivative. [Primary text](https://arxiv.org/html/2411.15454v1). Its [record](https://arxiv.org/abs/2411.15454), checked 11 September 2026, still lists only v1, submitted 23 November 2024.
...
3. [Canonical RA-13](https://github.com/ajt60gaibb/OpenProblemsInNLA/blob/main/randomized-and-low-rank-approximation/RA-13/README.md). The local page retains the full open target and separately attributed auxiliary counterexamples. Root is auditing the public fork/branch network; no exhaustive network claim is made by this draft.
