...
w=Path(__file__).resolve().parents[2]; p=w/'matrix-functions-and-stability/MF-21'
...
body=body.replace('\\section{MF-21:', '\\section*{MF-21:',1)
...
build=Path(tempfile.mkdtemp(prefix='mf21-solution-build-'))
for i in [1,2]:
