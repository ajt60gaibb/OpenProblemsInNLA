...
out={'result':'PASS','scope':'Finite exact supplemental checks only; universal proof in RESULT.md',
     'proof_sha256':hashlib.sha256(Path(__file__).with_name('RESULT.md').read_bytes()).hexdigest(),
