...
\usepackage{fancyvrb}
\hypersetup{pdftitle={Exact Rank of Complex Hankel Tensors},pdfsubject={An exact-rank formula for TR-14}}
...
The argument has not been independently peer reviewed or formalized in a proof
assistant. In particular, a successful run of the verification scripts is not
