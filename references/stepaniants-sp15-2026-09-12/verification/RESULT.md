# SP-15: an exceptional continuous fiber in dimension nine
...
**Prepared:** 12 September 2026 (UTC)  
**Status:** Complete proof candidate; independent review pending. No repository modification or publication is made by this note.
...
The question and generic finiteness theorem are due to Maxime Fortier Bourque and Thomas Ransford. Their theorem outside a closed measure-zero exceptional set is compatible with the exceptional nilpotent family above. The present note does not attribute that earlier theorem to the author of this note. The argument here is independent of the external matrix-theoretic conclusions in the references; the external general theorem used is the standard smooth constant-rank theorem.

- M. Fortier Bourque and T. Ransford, *Super-identical pseudospectra*, Journal of the London Mathematical Society **79**(2), 511–528 (2009), Theorem 1.4 and Section 6.2. https://doi.org/10.1112/jlms/jdn085 . The source asks whether the exceptional set may be empty.
- T. Ransford, *Pseudospectra and matrix behaviour*, Banach Center Publications **91**, 327–338 (2010), Theorem 5.4 and the ensuing discussion. https://www.impan.pl/shop/en/publication/transaction/download/product/86371 ; https://doi.org/10.4064/bc91-0-19 . Its generic invariant-theory argument does not exclude the family constructed here.
- G. Armentia, J. M. Gracia and F. E. Velasco, *Identical pseudospectra of any geometric multiplicity*, Linear Algebra and its Applications **436**(6), 1683–1688 (2012). https://doi.org/10.1016/j.laa.2011.01.014 . Their ordinary-similarity theorem is compatible with the fixed Jordan type of this family.

This proof was developed with substantial AI assistance. Independent mathematical review is required before any submission labels SP-15 solved. The public-network and later-literature eligibility check is recorded separately; neither a search nor a numerical check establishes the proof.
