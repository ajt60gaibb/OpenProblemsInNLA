...
The script \texttt{references/holden-tr03-2026-09-12/verify\_TR03.py} checks one radical-valued example exactly and constructs zero-diagonal bases for a fixed set of numerical spectra. These computations are illustrative; the proof above is independent of them.
