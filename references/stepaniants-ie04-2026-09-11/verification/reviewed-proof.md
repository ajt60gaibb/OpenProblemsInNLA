---
title: "A rare-event obstruction to the uniform exponential GEPP tail in IE-04"
subtitle: "An explicit robust-growth construction and a Gaussian small-box bound"
date: "September 2026"
---
...
`certificate.json` and `verification.txt` record the successful run. The earlier interrupted work contained the high-growth/small-box proof outline; this explicit version, including the constants and all inequalities, was completed and checked during recovery. The argument is submitted as an AI-assisted proof for review. No external human peer review, formal proof-assistant certification, or novelty/priority determination is claimed.
