...
{\small Center for Computational Biology, Flatiron Institute,\\
Simons Foundation, New York, USA}\par
\vspace{3mm}
...
\end{abstract}
\vfill
\noindent\small The restricted theorem is assembled from cited standard primitives and the derivations below. No claim of priority or independent peer review is made. External sources were accessed on 12 September 2026. Prepared with ChatGPT assistance; authorship supplied by Sidney Holden. Affiliation verified against the official Simons Foundation profile. Independent informal AI review is documented in the accompanying submission record.
\end{titlepage}
