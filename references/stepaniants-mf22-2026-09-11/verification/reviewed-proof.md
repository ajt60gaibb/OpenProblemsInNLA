# MF-22: an eventual linear condition-number bound

George Stepaniants  
Department of Computing and Mathematical Sciences, California Institute of Technology  
11 September 2026

**Status:** complete proof candidate, awaiting independent review. Developed with substantial assistance from a Codex agent. No external human peer review or formal verification is claimed. This note addresses the exact pure Toeplitz family in the canonical MF-22 statement, without corner corrections.
