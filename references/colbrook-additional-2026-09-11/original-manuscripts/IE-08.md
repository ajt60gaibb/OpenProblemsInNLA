...
**Proposed resolution of IE-08.** This manuscript claims a complete affirmative answer to the formulation in *Open Problems in Numerical Linear Algebra*. It is an AI-generated research proposal, not an independently reviewed theorem. No priority claim is made. The proof below is the evidence for the claim; the accompanying numerical experiments are diagnostics, not a proof or a production implementation.
