% Reviewed source SHA256 (UTF-8/LF): 9d5bb0083bd8521be5264ff70d81e49ef55c006f42f4a0874b851271534718a7
...
Both \eqref{eq:det} and \eqref{eq:mod} are reproducible with the supplied standard-library verifier \path{polynomial_coverage_independent.py}. It evaluates the seven products as untruncated integer polynomials, differentiates in each parameter direction using the product rule, and computes the integer determinant by fraction-free Bareiss elimination. The earlier discovery implementation is not included in this package. The supplied verifier requires no external dependencies and uses neither approximate rank nor floating-point determinants.
