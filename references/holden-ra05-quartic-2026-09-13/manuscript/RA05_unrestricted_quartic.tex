...
\hypersetup{colorlinks=true,linkcolor=MidnightBlue,citecolor=MidnightBlue,urlcolor=MidnightBlue,pdftitle={Sharp unrestricted quartic row coresets},pdfauthor={Sidney Holden}}
...
{\small Prepared with ChatGPT assistance.}\par September 2026
\vspace{0.25in}
\begin{abstract}
...
$D\le\max_{x\ {\rm in\ net}}Q(x)+\theta D$.
