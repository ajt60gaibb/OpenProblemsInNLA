...
Recovered target description: *Sharp growth for cyclic tridiagonal matrices*, provisionally IE-14 in OpenProblemsInNLA. The live statement and identifier have not been independently verified during reconstruction. Repository supplied for the task:[^1]
