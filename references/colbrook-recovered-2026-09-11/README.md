...
The [rook-pivoting note](submitted/research/rook_partial.md) and [independent review](verification/reviews/rook-review.md) establish the exact lower-bound example $g_{\mathrm{RP}}(5)\ge893/131$. This concerns order five, not the order-three/order-four constants asked for by IE-15. The order-five witness alone left IE-15 Open; the subsequent exact-growth resolution is recorded at the [canonical IE-15 entry](../../linear-systems-and-elimination/IE-15/README.md). No matching rook upper bound is supplied.
