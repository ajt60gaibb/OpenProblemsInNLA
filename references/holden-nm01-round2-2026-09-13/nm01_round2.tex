...
\hypersetup{pdftitle={NM-01, round two: projective recovery and exact SOS obstructions},pdfauthor={Sidney Holden},pdfsubject={Partial results, not a full resolution of NM-01}}
...
\vspace{0.18in}
{\small\color{muted}Prepared with ChatGPT assistance; the supplied draft described itself as AI-generated mathematical work. Independently reviewed by a separate Codex AI agent at the partial-results scope; see the accompanying review. No external human peer review or formal verification is claimed. The first-round archive is preserved unchanged. No broad novelty or priority claim is made.}\par
\end{titlepage}
