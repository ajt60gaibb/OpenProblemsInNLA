...
for folder,stem,review in [('MF-05_MF-07','uniform_growth_and_holder','MF-05-MF-07-review.md'),('MF-12','arbitrary_growth_exponents','MF-12-review.md')]:
    original=(root/'submitted'/folder/(stem+'.tex')).read_text(encoding='utf-8')
