...
\usepackage{fancyvrb}
\hypersetup{pdftitle={A rational completely positive matrix with no rational nonnegative factor},pdfsubject={PF-03: exact counterexample and unrestricted-width obstruction},pdfauthor={Sidney Holden}}
...
with no rational nonnegative factor}\par\medskip
{\large Sidney Holden}\par\smallskip
Center for Computational Biology, Flatiron Institute, Simons Foundation\par
13 September 2026
\end{center}
...
computer-assisted proof that passed an independent informal Codex AI-agent
audit on 13 September 2026; the accompanying independent-review report
records the checks. It has not received external human peer review or
...
claim relative to all existing literature is made. The accompanying
independent-review report records the subsequent informal Codex AI-agent
audit; no Lean verification was performed.
