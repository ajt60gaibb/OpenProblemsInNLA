...
\hypersetup{pdftitle={RA-14: Finite-Accuracy Lower Bounds},pdfsubject={Continuation 5: a universal adaptive lower bound; the full problem remains partial}}
...
The full RA-14 problem is therefore still \textbf{PARTIAL}. The new lower-bound proof and its exact remaining gap are written out below. This is an unreviewed mathematical research argument, not an independently certified or proof-assistant-verified result.
\end{abstract}
