...
- Global GitHub math check: no pages need formatting. Git diff whitespace check: passed for authored changes; the byte-preserved original experiments.csv uses CRLF and triggers whitespace notices. Its supplied bytes and digest are intentionally retained.
