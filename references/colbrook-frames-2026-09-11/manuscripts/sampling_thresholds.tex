% Reviewed source SHA256 (UTF-8/LF): 1412478dd874f64675071687d89e1cb73a729e03a5c307844276138f79ad902e
...
\noindent\textbf{Independently reviewed partial result.} These are fixed low-sparsity Walsh and full or nearly-full sampling regimes only. Theorem 2 uses complex vectors for complex unitary matrices and real vectors for real orthogonal matrices.
The dated \href{https://github.com/MColbrook/OpenProblemsInNLA/blob/codex/colbrook-frames-submissions/references/colbrook-frames-2026-09-11/verification/reviews/sampling-review.md}{independent agent review} records the subsequent checks and supersedes original draft remarks about pending review. This is not external human peer review or formal certification.
\par\medskip
% BEGIN REVIEWED BODY
