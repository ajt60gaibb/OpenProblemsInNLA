...
\hypersetup{pdftitle={Structural obstructions for PF-01},pdfauthor={Sidney Holden},pdfsubject={Partial research results and exact finite algebra certificates}}
\usepackage{enumitem}
