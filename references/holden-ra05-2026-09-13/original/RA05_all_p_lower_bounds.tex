...
\usepackage{bookmark}
\hypersetup{pdftitle={RA-05: An all-exponent obstruction to the proposed joint coreset bound},pdfauthor={Prepared with ChatGPT for Sidney Holden},pdfsubject={Strong row coresets, lower bounds, and proof audit}}
...
\vspace{0.32in}
Prepared for Sidney Holden with ChatGPT\\
September 12, 2026
\vspace{0.32in}
\begin{abstract}
