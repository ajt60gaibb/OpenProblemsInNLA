...
This package is prepared on an isolated branch from upstream main `16369809e6e600144bd350ab70b7473b652f46f1` for a separate resolution issue and new pull request against `ajt60gaibb/OpenProblemsInNLA:main`. Maintainer review and merge will be requested through that pull request; acceptance is pending. The coordinating agent handles catalog regeneration, permanent-ID safeguard checks and submission. This record will be updated with the concrete issue and pull-request links when created.
