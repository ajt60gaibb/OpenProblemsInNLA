#!/usr/bin/env python3
"""Read-only preservation check for the dated RA-12 bfaa1d0 integration.
...
ROOT = HERE.parents[2]
RECORD = HERE / 'main-integration-2026-09-12-bfaa1d0.json'
...
def main():
    ...
    for path in [ROOT / reference, HERE / 'main-integration-2026-09-12-bfaa1d0.md']:
