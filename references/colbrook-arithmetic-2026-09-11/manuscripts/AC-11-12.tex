...
\newcommand{\Om}{\Omega}
% BEGIN INPUT results_generated.tex
\newcommand{\MaxMinOrder}{35}
\newcommand{\MaxRangeOrder}{10}
\newcommand{\NewWitnessCount}{15}

% END INPUT results_generated.tex
\title{Exact finite cases of two\\sign-matrix permanent problems}
\author{{\large Matthew J. Colbrook}\\[3pt]{\small Department of Applied Mathematics and Theoretical Physics}\\{\small University of Cambridge, Cambridge, United Kingdom}\\{\small\href{mailto:m.colbrook@damtp.cam.ac.uk}{m.colbrook@damtp.cam.ac.uk}}\\[5pt]{\small 11 September 2026}}
\date{}
...
\begin{document}
\maketitle
\noindent\textbf{Submission and verification update (11 September 2026).} Independently reviewed finite-case results: AC-11 through order 35 and AC-12 through order 10. Both universal targets remain partially resolved. The supplied work is AI-assisted. The analytic review and fresh exact certificate checks are recorded separately in the submission record. The dated reports supersede original pending-review remarks. Independent agent review is not external human peer review or formal certification; no novelty or priority claim is made. See the \href{https://github.com/MColbrook/OpenProblemsInNLA/tree/codex/colbrook-arithmetic-submissions/references/colbrook-arithmetic-2026-09-11}{submission record}.
\par\medskip
...
\begin{table}[htbp]
\centering\small
% BEGIN INPUT minimum_tabular.tex
\begin{tabular}{rrrl}
\toprule
...
% BEGIN INPUT example_cofactors.tex
\[
\begin{array}{rrrrrrr}
...
% END INPUT example_cofactors.tex
