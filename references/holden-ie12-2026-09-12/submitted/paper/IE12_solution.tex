...
\hypersetup{colorlinks=true,linkcolor=inkblue,citecolor=inkblue,urlcolor=inkblue,
  ...
  pdfauthor={ChatGPT; prepared in response to the IE-12 request},
...
\vspace{9pt}
{Prepared by ChatGPT in this conversation}\par
{12 September 2026}
\end{center}
...
illustrations. It has not been independently peer-reviewed or checked by a
proof assistant. The theorem is about exact-real scalar complexity, not
