...
This manuscript was prepared with assistance from OpenAI Codex. The accompanying review records identify the exact version checked by independent Codex agents. Such review is neither human peer review nor formal verification.
...
1. **MI-28.** MColbrook/OpenProblemsInNLA. *Ghabries's determinant comparison for arbitrary nonnegative base powers*. [Canonical problem statement](https://github.com/MColbrook/OpenProblemsInNLA/blob/main/matrix-inequalities-and-norms/MI-28/README.md).
