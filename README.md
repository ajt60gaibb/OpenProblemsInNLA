...
<!-- catalog-summary -->
**172 problems with open targets:** 94 open and 78 partially resolved. **31 other retained entries**, excluded from the open count.

Each entry records its own literature-check date. Literature checks are bounded; ratings are editorial. “Impact” uses the canonical `Importance` field.

**[Browse all 172 open targets →](CATALOG.md)** · **[Solved and claimed solutions →](RESOLVED.md)**
<!-- /catalog-summary -->
