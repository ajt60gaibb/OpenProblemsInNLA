...
| --- | --- | --- | --- | --- |
| [IV-01](IV-01/README.md) | Two-vertex certification of nonsingular sign regularity | challenging | interesting to specialist | [PDF](IV-01/problem.pdf) · [TeX](IV-01/problem.tex) |
| [IV-02](IV-02/README.md) | Exact determinant ranges of general tridiagonal interval matrices | challenging | interesting to the community | [PDF](IV-02/problem.pdf) · [TeX](IV-02/problem.tex) |
| [AV-01](AV-01/README.md) | Recognizing the maximum finite number of solutions | challenging | interesting to specialist | [PDF](AV-01/problem.pdf) · [TeX](AV-01/problem.tex) |
